...
import com.dfjinxin.auth.server.bean.ClientInfo;
import com.dfjinxin.auth.server.entity.Client;
import com.dfjinxin.auth.server.mapper.ClientMapper;
import com.dfjinxin.auth.server.util.client.ClientTokenUtil;
import com.dfjinxin.auth.server.service.AuthClientService;
import com.dfjinxin.common.exception.auth.ClientInvalidException;
import com.dfjinxin.common.util.UUIDUtils;
